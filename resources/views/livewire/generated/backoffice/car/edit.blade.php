<x-laragen::form wire:submit.prevent="submit" class="pb-7 bg-white shadow rounded px-7">                    @includeIf('app.backoffice.car.edit.fieldset.74.before')
        <fieldset>

                            <legend>
                    <h2>Default fieldset</h2>
                                            <p class="mt-3 text-base text-gray-400">Default fieldset desc</p>
                                        @includeIf('app.backoffice.car.edit.fieldset.74.legend_description')
                </legend>
            
            <div class="flex-1 -mx-2">
                @includeIf('app.backoffice.car.edit.fieldset.74.content_before')
                    ...
                    @includeIf('app.backoffice.car.fields.edit.name_after')
                                @includeIf('app.backoffice.car.edit.fieldset.74.content_after')
            </div>

        </fieldset>
        @includeIf('app.backoffice.car.edit.fieldset.74.after')
