<x-laragen::form wire:submit.prevent="submit" class="pb-7 bg-white shadow rounded px-7">                    @includeIf('app.user.user.edit.fieldset.73.before')
        <fieldset>

            
            <div class="flex-1 -mx-2">
                @includeIf('app.user.user.edit.fieldset.73.content_before')
                    ...
                    @includeIf('app.user.user.fields.edit.email_after')
                                @includeIf('app.user.user.edit.fieldset.73.content_after')
            </div>

        </fieldset>
        @includeIf('app.user.user.edit.fieldset.73.after')
